...
function checkUpdateScroll() {
  //Throttle scroll event since it fires often
  if (!checkUpdateScroll.updating) {
    checkUpdateScroll.updating = true;
...
function scrolledLessthan(scrollAmount, height, amount) {
  return (scrollAmount <= (height / amount));
}
